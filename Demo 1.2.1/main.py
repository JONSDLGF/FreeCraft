...
from gui.render import render_gui, render_debug         # por lo tanto en la 1.3.X sera la gui update
# chat y menus
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_ESCAPE:
                    running = False # despues se cambiara para agregar el menu del juego
            ...
            while running:
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.KEYDOWN:
                        if event.key == pygame.K_ESCAPE:
                            running = False
                # agregar el menu aqui
        elif menu_=="game":
            game(width, height, debug)
            menu_="exit" # despues se cambiara por main para ir al menu principal
        elif menu_=="exit":
            return 0
