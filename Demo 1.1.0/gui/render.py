...
def render_gui():
    ...
    gl.glPushMatrix()
    gl.glLoadIdentity()
    gl.glOrtho(0, 800, 600, 0, -1, 1)  # Ajustado para resolución 800x600
    gl.glMatrixMode(gl.GL_MODELVIEW)
    gl.glLoadIdentity()

    # Renderizar una cruz en el centro (como en Minecraft)
    gl.glBegin(gl.GL_LINES)
    gl.glColor3f(255.0, 1.0, 1.0)  # Blanco
    # Línea vertical
    gl.glVertex2f(400, 390)  # Centro (800/2, 600/2) - 10
    gl.glVertex2f(400, 410)  # Centro + 10
    # Línea horizontal
    gl.glVertex2f(390, 400)  # Centro - 10
    gl.glVertex2f(410, 400)  # Centro + 10
    gl.glEnd()
